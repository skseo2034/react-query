...
import { Appointment, AppointmentDateMap, User } from '../../../../shared/types';
...
export function getAvailableAppointments(appointments: AppointmentDateMap, user: User | null): AppointmentDateMap {
	...
	Object.keys(filteredAppointments).forEach((date: any) => {
